...
const About = () => {
  return (
    <div className='py-20 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>About N<span className='text-orange-600'>estly</span></h1>
      <p  className='mb-4 text-slate-700'  >
      Nestly is a leading real estate agency that specializes 
      in helping clients buy, sell, and rent properties in the most desirable 
      neighborhoods. Our team of experienced agents is dedicated to providing exceptional 
      ...
      of the local market. Whether you are looking
